...
import 'package:flutter/widgets.dart' hide ScrollPositionWithSingleContext;
...
/// Signature for when a [ScrollController2] has added or removed a
/// [ScrollPosition].
///
/// Since a [ScrollPosition] is not created and attached to a controller until
/// the ] is built, this can be used to respond to the position being
...
///
/// Used by [ScrollController2.onAttach] and [ScrollController2.onDetach].
typedef ScrollControllerCallback2 = void Function(ScrollPosition position);
...
/// to an individual [widget. To use a custom [ScrollPosition],
/// subclass [ScrollController2] and override [createScrollPosition].
///
...
///    [ScrollController2].
///  * [, which is the lower-level widget that creates and associates
///    [ScrollPosition] objects with [ScrollController2] objects.
...
///    listen to scrolling occur without using a [ScrollController2].
class ScrollController2 extends ScrollController {
  ...
  ///
  /// Since a scroll position is not attached until a  is actually
  ...
  /// determined until the has finished laying out its contents and
  ...
  /// [ScrollPosition.isScrollingNotifier] using [ScrollController2.onAttach].
  ...
  /// {@end-tool}
  final ScrollControllerCallback2? onAttach;
  ...
  /// This sample shows how to apply a listener to the
  /// [ScrollPosition.isScrollingNotifier] using [ScrollController2.onAttach]
  /// & [ScrollController2.onDetach].
  /// This is used to change the [AppBar]'s color when scrolling is occurring.
  ///
  /// ** See code in examples/api/lib/widgets/scroll_position/scroll_controller_on_attach.0.dart **
  /// {@end-tool}
  final ScrollControllerCallback2? onDetach;
  ...
  /// [ScrollController2] using the [attach] method.
  ///
  ...
  /// Creates a [ScrollPosition] for use by a  widget.
  ///
  ...
  /// resizes.
  ///
  /// By default, returns a [ScrollPositionWithSingleContext2].
  ///
  ...
  ///    creates the ], or, if none was provided, from the ambient
  ///    [ScrollConfiguration].
  ...
  ///    been created for this ], this will be the previous instance.
  ///    This is used when the environment has changed and the ]
  ...
  ScrollPosition createScrollPosition(
    ...
    return ScrollPositionWithSingleContext2(
      physics: physics,
      context: context,
  ...
  /// the [ScrollController2] base class calls [debugFillDescription] to collect
...
/// A [ScrollController2] whose [initialScrollOffset] tracks its most recently
/// updated [ScrollPosition].
///
/// This class can be used to synchronize the scroll offset of two or more
/// lazily created scroll views that share a single [TrackingScrollController2].
...
/// [ListView]'s share a [TrackingScrollController2]. The scroll offsets of all
...
class TrackingScrollController2 extends ScrollController2 {
  ...
  /// See also:
  ///
  ///  * [ScrollController2.initialScrollOffset], which this overrides.
  @override
