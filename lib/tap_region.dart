...
class TapRegionSurface extends StatefulWidget {
  const TapRegionSurface({super.key});

  State<TapRegionSurface> createState() => _TapRegionSurfaceState();
}

class _TapRegionSurfaceState extends State<TapRegionSurface> {
  @override
...
abstract class TapRegionRegistry {
  ...
  static TapRegionRegistry? maybeOf(BuildContext context) {
    return context.dependOnInheritedWidgetOfExactType<RenderTapRegionSurface>();
  }
}
