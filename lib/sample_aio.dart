...
import 'package:flutter/material.dart' show ButtonStyle, ButtonStyleButton, Checkbox, ColorScheme, Colors, Icons, InteractiveInkFeatureFactory, Material, MaterialLocalizations, MaterialTapTargetSize, MaterialType, MenuBarTheme, MenuButtonTheme, MenuStyle, MenuTheme, MenuThemeData, Radio, Scrollbar, TextButton, TextTheme, Theme, VisualDensity, WidgetPropertyResolver, WidgetState, WidgetStateMouseCursor, WidgetStateProperty, WidgetStatePropertyAll, WidgetStatesController, kThemeChangeDuration;
...
class _MatMenuItemLabel extends StatelessWidget {
  /// Creates a const [_MatMenuItemLabel].
  ///
  /// The [child] and [hasSubmenu] arguments are required.
  const _MatMenuItemLabel({
...
// visible in the view.
class _MatMenuLayout extends SingleChildLayoutDelegate {
  const _MatMenuLayout({
  ...
  @override
  bool shouldRelayout(_MatMenuLayout oldDelegate) {
